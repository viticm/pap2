...
typedef struct {		/* Bitreading state saved across MCUs */
  ...
  boolean_def printed_eod;		/* flag to suppress multiple warning msgs */
} bitread_perm_state;
...
typedef struct {		/* Bitreading working state within an MCU */
  ...
  boolean_def * printed_eod_ptr;	/* => flag in permanent state */
...
EXTERN(boolean_def) jpeg_fill_bit_buffer
