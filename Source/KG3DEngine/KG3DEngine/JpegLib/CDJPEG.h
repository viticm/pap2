...
EXTERN(boolean_def) read_quant_tables JPP((j_compress_ptr cinfo, char * filename,
				    int scale_factor, boolean_def force_baseline));
EXTERN(boolean_def) read_scan_script JPP((j_compress_ptr cinfo, char * filename));
EXTERN(boolean_def) set_quant_slots JPP((j_compress_ptr cinfo, char *arg));
EXTERN(boolean_def) set_sample_factors JPP((j_compress_ptr cinfo, char *arg));
...
EXTERN(boolean_def) keymatch JPP((char * arg, const char * keyword, int minchars));
