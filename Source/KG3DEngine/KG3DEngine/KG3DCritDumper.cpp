...
// GLOBALS
//-----------------------------------------------------------------------------
KG3DCritDumper* KG3DCritDumper::s_pMiniDumper = NULL;
LPCRITICAL_SECTION KG3DCritDumper::s_pCriticalSection = NULL;
...
// Desc: Constructor
//-----------------------------------------------------------------------------
KG3DCritDumper::KG3DCritDumper( bool bPromptUserForMiniDump )
{
	// Our KG3DCritDumper should act alone as a singleton.
...
//-----------------------------------------------------------------------------
LONG KG3DCritDumper::unhandledExceptionHandler( _EXCEPTION_POINTERS *pExceptionInfo )
{
	if( !s_pMiniDumper )
...
//-----------------------------------------------------------------------------
BOOL KG3DCritDumper::enablePrivilege( LPCTSTR pszPriv, HANDLE hToken, TOKEN_PRIVILEGES* ptpOld )
{
    BOOL bOk = FALSE;
...
// Desc: 
//-----------------------------------------------------------------------------
BOOL KG3DCritDumper::restorePrivilege( HANDLE hToken, TOKEN_PRIVILEGES* ptpOld )
{
