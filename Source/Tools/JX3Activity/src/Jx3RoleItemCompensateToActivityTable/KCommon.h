...
DLLDECL int GetRepresentId(PARSEHANDLE hParser, unsigned short dwRepresentId[], int& nSize);
//获取角色上次存盘时间
...
//参数说明:unsigned long dwQuestIndex任务索引(从1开始), unsigned char& dwQuestState 任务状态
