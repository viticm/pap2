...
namespace Fireball.Windows.Forms
{
	...
	public class CodeEditorControl : Widget
	{
        ...
        private string _FontName = "ÐÂËÎÌå";
       ...
       // [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		public int InfoTipSelectedIndex
		{
			...
			set
			{
				if (_ActiveView == null || _ActiveView.IsDisposed || _ActiveView.InfoTip == null || _ActiveView.InfoTip.IsDisposed)
					return;
                while (_ActiveView.InfoTip.tlist.Count-1 < value)
                    _ActiveView.InfoTip.tlist.Add("");
                _ActiveView.InfoTip.tlist_pos = value;
       ...
       // [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		public int InfoTipCount
		{
			...
			set
			{
				if (_ActiveView == null || _ActiveView.IsDisposed || _ActiveView.InfoTip == null || _ActiveView.InfoTip.IsDisposed)
					return;
                while (_ActiveView.InfoTip.tlist.Count > value)
                    _ActiveView.InfoTip.tlist.RemoveAt(_ActiveView.InfoTip.tlist.Count - 1);
                while (_ActiveView.InfoTip.tlist.Count < value)
                    _ActiveView.InfoTip.tlist.Add("");
		...
		public string InfoTipText
		{
			...
			set
			{
                if (_ActiveView == null || _ActiveView.IsDisposed || _ActiveView.InfoTip == null || _ActiveView.InfoTip.IsDisposed)
					return;
                if (_ActiveView.InfoTip.tlist.Count < _ActiveView.InfoTip.tlist_pos)
                {
                    return;
                }
                _ActiveView.InfoTip.tlist[_ActiveView.InfoTip.tlist_pos] = value;
     ...
     //   [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        {
            _ActiveView.SetupFindText();
        }

        public void FindNextSelectText()
        {
            _ActiveView.FindNextSelectText();
        }

        public void FindPreviousSelectText()
        {
            _ActiveView.FindPreviousSelectText();
        }
        ...
        {
            _ActiveView.SelectText(RowIndex, Column, Length);
        }
