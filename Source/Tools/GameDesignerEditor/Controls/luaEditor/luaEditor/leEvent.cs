...
namespace luaEditor
{
    ...
    public class leParm
    {
        public leParm(string name, Type type, MethodInfo mi, string strNS)
        {
            this.parm_name = name;
            this.parm_type = type;
            this.mi = mi;
        ...
        public leParm(string name, string parm_classname, string strNS)
        {
            this.parm_name = name;
            this.parm_type = null;
            this.mi = null;
        ...
        public leParm(string name, Type type, string strNS)
        {
            this.parm_name = name;
            this.parm_type = type;
            this.mi = null;
    ...
    public class leEvent
    {
        ...
        public List<leParm> parms;
        public string info;

        public leEvent(string eventName, List<leParm> parms, string info)
        {
        ...
        public leEvent(string eventName, List<leParm> parms)
        {
            this.eventName = eventName;
            this.parms = parms;
        }
    ...
    {
        public List<leEvent> m_list = new List<leEvent>();
    };

    public static class leParmsCache
    {
        //所有参数的缓存，嗷嗷重要
        public static List<leParm> leParm_Cache = new List<leParm>();
        ...
        public static void regEvent(QueryEventsArgs e, string funcName, string strInfo, leParm lep1)
        {
            List<leParm> tlist = new List<leParm>();
            tlist.Add(lep1);
            e.leec.m_list.Add(new leEvent(funcName, tlist, strInfo));
        }
        public static void regEvent(QueryEventsArgs e, string funcName, string strInfo, leParm lep1, leParm lep2)
        {
            List<leParm> tlist = new List<leParm>();
            tlist.Add(lep1);
            tlist.Add(lep2);
        ...
        public static void regEvent(QueryEventsArgs e, string funcName, string strInfo, leParm lep1, leParm lep2, leParm lep3)
        {
            List<leParm> tlist = new List<leParm>();
            tlist.Add(lep1);
            tlist.Add(lep2);
        ...
        {
            List<String> ret = new List<string>();
            foreach (leParm lp in leParm_Cache)
            {
                if (lp.parm_name == "") 
                    continue;
