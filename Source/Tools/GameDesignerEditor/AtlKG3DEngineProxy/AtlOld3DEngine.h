// AtlOld3DEngine.h : Declaration of the CAtlOld3DEngine

#pragma once
#include "resource.h"       // main symbols

#include "AtlKG3DEngineProxy.h"
#include "./AtlTest3DEngine/InputProxy.h"
...
class ATL_NO_VTABLE CAtlOld3DEngine :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CAtlOld3DEngine, &CLSID_AtlOld3DEngine>,
	public IDispatchImpl<IAtlOld3DEngine, &IID_IAtlOld3DEngine, &LIBID_AtlKG3DEngineProxyLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
	CAtlOld3DEngine()
	{
...
DECLARE_REGISTRY_RESOURCEID(IDR_ATLOLD3DENGINE)


BEGIN_COM_MAP(CAtlOld3DEngine)
	COM_INTERFACE_ENTRY(IAtlOld3DEngine)
...
public:
	STDMETHOD(Init)(LONG hwndBase, BSTR strEnginePath, BSTR strStartUpPath);
	...
	STDMETHOD(GetInitInfo(LONG* hwndBase, BSTR* strEnginePath, BSTR* strStartUpPath));
private:
	...
	BSTR m_strEnginePath;
	BSTR m_strStartUpPath;
...
OBJECT_ENTRY_AUTO(__uuidof(AtlOld3DEngine), CAtlOld3DEngine)
