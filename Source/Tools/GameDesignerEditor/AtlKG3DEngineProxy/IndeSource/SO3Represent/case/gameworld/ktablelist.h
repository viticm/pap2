...
public:
    ...
    KRidesEquipModel       const* GetRidesEquipModel(int nIndex, DWORD dwRidesID, DWORD dwModelID) const;
    KRidesEquipModel       const* GetRidesSocketModel(int nIndex, DWORD dwRidesID, DWORD dwModelID) const;
    ...
    KNpcAnimationModel const* GetNpcAnimationModel(DWORD dwRepresentID, DWORD dwAnimationID) const;
...
private:
    ...
    KRidesEquipModel* m_pRidesSocketModel[MODEL_RIDES_SOCKET_COUNT];
    ...
    KBinTab	m_NpcAnimationTab;
    KNpcAnimationModel* m_pNpcAnimationModel;
    size_t m_nNpcAnimationCount;
