...
public:
    ...
    virtual HRESULT Activate(DWORD dwTickCount, DWORD dwGameLoop, BOOL bFrame);
    ...
    virtual HRESULT GetSceneObjectData(DWORD dwScene, DWORD dwObjectType, DWORD dwObject, KRepresentSceneObjectData* pData);
