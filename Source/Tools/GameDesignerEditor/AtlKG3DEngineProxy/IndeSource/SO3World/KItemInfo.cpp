...
int KCustomEquipInfo::LuaGetMagicAttrib(Lua_State* L)
{
	...
	{
		KAttribInfo *pInfo = g_pSO3World->m_ItemManager.m_pItemLib[nVersion].GetAttribInfo(nAttribIndex[i]);
...
int KCustomEquipInfo::LuaGetSetAttrib(Lua_State* L)
{
	...
	pSetInfo = g_pSO3World->m_ItemManager.m_pItemLib[CURRENT_ITEM_VERSION].GetSetInfo(nSetID);
