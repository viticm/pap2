...
BOOL KTeamClient::ChangeMember(DWORD dwMemberID, int nSrcGroupIndex, int nDstGroupIndex)
{
    BOOL bResult = false;
...
BOOL KTeamClient::IsPlayerInParty(DWORD dwPlayerID)
{
    BOOL                            bResult = false;
...
int KTeamClient::LuaCanSetTeamDistributeMan(Lua_State* L)
{
    ...
    KGLOG_PROCESS_ERROR(pClientPlayer->m_dwTeamID != ERROR_ID);
...
int KTeamClient::LuaSetTeamFormationLeader(Lua_State* L)
{
    ...
    KG_PROCESS_ERROR(pClientPlayer->m_dwTeamID != ERROR_ID);
...
int KTeamClient::LuaChangeMemberGroup(Lua_State* L)
{
    ...
    g_PlayerClient.DoTeamChangeMemberGroupRequest(dwMemberID, nDstGroup);
