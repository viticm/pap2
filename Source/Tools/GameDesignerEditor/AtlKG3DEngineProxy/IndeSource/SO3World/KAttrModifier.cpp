...
BOOL ProcessParryValueBase(KCharacter* pDstCharacter, BOOL bApply, int nValue1, int nValue2)
{
    ...
    pDstCharacter->m_nParryValue =
        pDstCharacter->m_nParryValueBase * pDstCharacter->m_nParryValuePercent / KILO_NUM;
...
BOOL ProcessCriticalDamagePowerBaseKiloNumRate(KCharacter* pDstCharacter, BOOL bApply, int nValue1, int nValue2)
{
    BOOL bResult = false;

    pDstCharacter->m_nCriticalDamagePowerBaseKiloNumRate += (bApply ? nValue1 : -nValue1);
...
BOOL ProcessCriticalDamagePowerBase(KCharacter* pDstCharacter, BOOL bApply, int nValue1, int nValue2)
{
    BOOL bResult = false;

    pDstCharacter->m_nCriticalDamagePowerBase += (bApply ? nValue1 : -nValue1);

    pDstCharacter->m_nCriticalDamagePower =
        pDstCharacter->m_nCriticalDamagePowerBase * pDstCharacter->m_nCriticalDamagePowerPercent / KILO_NUM;
...
BOOL ProcessCriticalDamagePowerPercent(KCharacter* pDstCharacter, BOOL bApply, int nValue1, int nValue2)
{
    BOOL bResult = false;

    pDstCharacter->m_nCriticalDamagePowerPercent += (bApply ? nValue1 : -nValue1);
...
BOOL ProcessTransmission(KCharacter* pDstCharacter, BOOL bApply, int nValue1, int nValue2)
{
    ...
    bRetCode = pPlayer->SwitchMap(dwMapID, 0, nX, nY, nZ); 
    KGLOG_PROCESS_ERROR(bRetCode);
#endif
...
BOOL ProcessVitalityToParryValueCof(KCharacter* pDstCharacter, BOOL bApply, int nValue1, int nValue2)
{
    ...
    pPlayer->m_nParryValue = pPlayer->m_nParryValueBase * pPlayer->m_nParryValuePercent / KILO_NUM;
...
BOOL InitAttributeFunctions()
{
    ...
    g_AttributeProcessFunctions[atCriticalDamagePowerBaseKiloNumRate]     = ProcessCriticalDamagePowerBaseKiloNumRate;
    g_AttributeProcessFunctions[atCriticalDamagePowerBase]      = ProcessCriticalDamagePowerBase;
    g_AttributeProcessFunctions[atCriticalDamagePowerPercent]   = ProcessCriticalDamagePowerPercent;
