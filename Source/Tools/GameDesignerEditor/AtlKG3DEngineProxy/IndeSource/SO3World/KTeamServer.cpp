...
BOOL KTeamServer::ChangeMember(DWORD dwTeamID, int nSrcGroupIndex, int nDstGroupIndex, DWORD dwPlayerID)
{
    BOOL        bResult = false;
    KPlayer*    pPlayer = NULL;
    KTeam*      pTeam   = NULL;
...
BOOL KTeamServer::IsPlayerInParty(DWORD dwTeamID, DWORD dwPlayerID)
{
    BOOL                bResult = false;
