...
KLuaConst LUA_ATTRIBUTE_TYPE[] =
{
    ...
    {"CRITICAL_DAMAGE_POWER_BASE_KILONUM_RATE",     atCriticalDamagePowerBaseKiloNumRate}, 
    {"CRITICAL_DAMAGE_POWER_BASE",          atCriticalDamagePowerBase}, 
    {"CRITICAL_DAMAGE_POWER_PERCENT",       atCriticalDamagePowerPercent},
...
{    
	...
	{"BY_PLAYER",				drcRevivedByPlayer},
	{"IN_ALTAR",				drcRevivedInAltar},
	{NULL,                      0}
};
...
KLuaConst LUA_CONST_LOGIN[] = 
{
	...
	{ _T("DELETE_ROLE_BAD_PASSWORD"),				LPUM_DELETE_ROLE_BAD_PASSWORD },
	{ _T("DELETE_ROLE_NOT_ALLOWED"),				LPUM_DELETE_ROLE_NOT_ALLOWED },
...
KLuaConst LUA_TONG_OPERATION_INDEX[] =
{
    ...
    {"MODIFY_ONLINEMESSAGE",        totModifyOnlineMessage},
    ...
    //{"GET_FROM_REPOSITORY_PAGE1",   totGetFromRepositoryPage1},
