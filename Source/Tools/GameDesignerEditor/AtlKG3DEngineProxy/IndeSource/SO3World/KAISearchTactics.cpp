...
BOOL KSearchForDoodad::operator ()(KDoodad* pDoodad)
{
	BOOL	bRetCode = false;
	int     nSrcZ       = 0;
	int     nDstZ       = 0;
...
BOOL KSearchForPartyMember::operator ()(KPlayer* pPlayer)
{
    return true;
}

BOOL KSearchForAllies::operator ()(KCharacter* pCharacter)
{
	BOOL	bRetCode	= false;
	int     nSrcZ       = 0;
	int     nDstZ       = 0;
