...
namespace DataTransmission.Common
{
    ...
    public abstract class OracleHelper {
        public static readonly string Conn = System.Configuration.ConfigurationSettings.AppSettings["DesConn"].ToString();
        ...
        /// <param name="SQLString"></param>
        /// <returns>DataSet</returns>
        public static DataSet ExecuteDataSet(string connectionString, CommandType cmdType, string SQLString, params OracleParameter[] cmdParms)
        {
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                OracleCommand cmd = new OracleCommand();
