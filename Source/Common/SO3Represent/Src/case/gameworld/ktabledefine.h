...
enum
{
    ...
    RL_NUMBER_CAPTION_FLOOR_SPACE_HEIGHT,

    RL_NUMBER_CAPTION_LIFE_HEIGHT,
    RL_NUMBER_CAPTION_TONG_HEIGHT,
    RL_NUMBER_CAPTION_TITLE_HEIGHT,
    RL_NUMBER_CAPTION_NAME_HEIGHT,
    RL_NUMBER_CAPTION_MARK_HEIGHT,
    RL_NUMBER_CAPTION_MARK_SPACE_HEIGHT,
    ...
    RL_NUMBER_OPTIMIZATION_HINT_FPS,
    RL_NUMBER_OPTIMIZATION_START_TIME,
    RL_NUMBER_OPTIMIZATION_EVALUATION_TIME,

    RL_NUMBER_REMOTE_CHARACTER_FRAMEDATA_DELAY_TIME,

    RL_NUMBER_CAMERA_RESET_MODE,
    RL_NUMBER_CAMERA_DRAG_SPEED,
    RL_NUMBER_CAMERA_MAX_DISTANCE,
    RL_NUMBER_CAMERA_RESET_SPEED,
    RL_NUMBER_CAMERA_INIT_YAW,
    RL_NUMBER_CAMERA_INIT_PITCH,
    RL_NUMBER_CAMERA_INIT_ROLL,
...
struct KRidesModel
{
    ...
    int nColorChannel;
    LPCTSTR szBodyMesh;
    LPCTSTR szBodyMaterial;
    int nBodyGlobalColorChannel;
    int nBodyColorChannel;
    LPCTSTR szManeMesh;
    LPCTSTR szManeMaterial;
    int nManeGlobalColorChannel;
    int nManeColorChannel;
...
struct KRidesSocketModel
{
    ...
    bool operator<(KRidesSocketModel const& rhs) const
    {
        return dwModelID < rhs.dwModelID;
    }
};
...
struct KNpcAnimationModel
{
    ...
    static int Compare(const void *pvLModel, const void *pvRModel) 
    {
        int nResult = false;

        const KNpcAnimationModel *pLModel = (const KNpcAnimationModel *)pvLModel;
        const KNpcAnimationModel *pRModel = (const KNpcAnimationModel *)pvRModel;

        if (pLModel->dwRepresentID == pRModel->dwRepresentID)
        {
            nResult = pLModel->dwAnimationID - pRModel->dwAnimationID;
        }
        else
        {
            nResult = pLModel->dwRepresentID - pRModel->dwRepresentID;
        }
