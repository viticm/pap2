...
#include "../gameworld/krlremotecharacterframedata.h"
...
public:
    ...
    int UpdatePosition(BOOL bUpdateDisplayData);
...
private:
    ...
    void UpdateLifeState(BOOL bUpdateDisplayData);
    ...
    int UpdateAnimationUp();

public:
    KRLCharacter m_RLCharacter;
    KRLRemoteCharacterFrameData m_FrameData;
