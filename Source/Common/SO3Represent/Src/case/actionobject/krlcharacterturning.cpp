...
static RL_TURNING GetTurningStandFootDirectionByFaceFootDeltaYaw(float fFaceFootDeltaYaw, float fPreviousFaceFootDeltaYaw)
{
...
static RL_TURNING GetTurningStandFootDirectionByFaceFootYaw(float fFaceYaw, float fFootYaw)
{
    float fDeltaYaw = NormalizeDirectionNegativeHalfToPositiveHalf(fFaceYaw - fFootYaw);
...
static RL_TURNING GetTurningStandNone(RL_TURNING nTurning, float fFaceYaw, float fFootYaw, float fPreviousFaceYaw, float fPreviousFootYaw)
{
    ...
    if (abs(fFaceFootDeltaYaw) >= D3DX_PI / 2.01f)
    {
        ...
        nTurning = GetTurningStandFootDirectionByFaceFootDeltaYaw(fFaceFootDeltaYaw, fPreviousFaceFootDeltaYaw);
    }
    else
    {
        if (abs(fFaceFootDeltaYaw) > YAW_EPSILON)
        {
            ...
            if (nTurning == RL_TURNING_STAND_NONE)
            {
                ...
                nTurning = GetTurningStandFootDirectionByFaceFootDeltaYaw(fPreviousFaceFootDeltaYaw, fFaceFootDeltaYaw);
            }
        }
    }

    if (nTurning == RL_TURNING_STAND_NONE)
        nTurning = GetTurningStandFootDirectionByFaceFootYaw(fFaceYaw, fFootYaw);
