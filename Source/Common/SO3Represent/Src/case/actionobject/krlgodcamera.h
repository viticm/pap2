...
private:
    ...
    int ComputeForwardMove(const int nControls[], int* pnForwardMove);
    int ComputeStrafeMove(const int nControls[], int *pnStrafeMove);
    int ComputeUpMove(const int nControls[], int *pnUpMove);
