...
struct KRLTraceOption
{
    ...
    BOOL bTraceCamera;
    BOOL bTraceTarget;
    BOOL bTraceFrameInterval;

    BOOL bTracePrefetchCharacterPosition;
    BOOL bTraceFrameTime;
    BOOL bTraceCharacterControl;
    BOOL bTraceMsg;
    BOOL bTraceCharacter;
};

#endif // RL_TRACE_OPTION

struct KRLDebugOption
{
    BOOL bDisableAnimation;
    BOOL bDisableRemoteCharacterInterpolate;
};
